...
def test(model, model_name, criterion, test_loader):
    ...
    with torch.no_grad():
        ...
        with open("./model_performance/distillation_model_performance.txt", "a") as f:
...
def main(model, model_name, data_loader):
    ...
    model_state_dict_path = f"model_distillation_pth/best_model_weights_{model_name}_lambda_0.9_beta_0.1.pth"
